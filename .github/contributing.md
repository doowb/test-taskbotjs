# Contributing to test-taskbotjs

First and foremost, thank you! We appreciate that you want to contribute to test-taskbotjs, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for test-taskbotjs**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for test-taskbotjs:

- star the [project](https://github.com/doowb/test-taskbotjs)
- tweet your support for test-taskbotjs
...
- **version**: please note the version of test-taskbotjs are you using
- **extensions, plugins, helpers, etc** (if applicable): please list any extensions you're using
- **error messages**: please paste any error messages into the issue, or a [gist](https://gist.github.com/)

### Closing issues

The original poster or the maintainer's of test-taskbotjs may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/test-taskbotjs
